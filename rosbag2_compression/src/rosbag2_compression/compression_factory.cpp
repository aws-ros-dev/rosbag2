...
: impl_(std::make_unique<CompressionFactoryImpl>())
{}
...
CompressionFactory::create_decompressor(const std::string & decompression_format)
{
  return impl_->create_decompressor(decompression_format);
}

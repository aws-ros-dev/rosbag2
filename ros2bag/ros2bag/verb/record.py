...
class RecordVerb(VerbExtension):
    ...
    def add_arguments(self, parser, cli_name):  # noqa: D102
        ...
        parser.add_argument(
            '--max-bagfile-size', type=int, default=0,
            help='maximum size in bytes before the bag file will be split.'
                 'Default splitting is disabled.')
    ...
    def main(self, *, args):  # noqa: D102
        ...
        if args.all:
            ...
            rosbag2_transport_py.record(
                ...
                max_bagfile_size=args.max_bagfile_size)
